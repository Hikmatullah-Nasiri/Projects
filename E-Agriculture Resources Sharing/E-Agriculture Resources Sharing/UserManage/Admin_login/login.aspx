                    ...
                    <div class="col-md-6 col-sm-8 mx-auto">
                       <div class="card border-none">
                           <a href="../../Default.aspx" class="btn btn-dark float-right" style=" text-decoration:none;opacity:0.5; background-color:#000;">Home</a>
                            <div class="card-body">
                                <div class="mt-2">
                                    <span class="dot" style="  height: 120px; width: 120px;background-color: #d81a1a;border-radius: 50%;display: inline-block;margin-left:190px;"></span>
                                ...
                                <p class="text-center">
                                       Note: For authotized users only! 
                                </p>
                            </div>
                        </div>
                    </div>
